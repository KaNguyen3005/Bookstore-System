...
INSERT INTO `users` (`user_id`, `username`, `password`, `name`, `email`, `phone`, `status`, `gender`, `tier`, `point`, `avatar_url`, `public_id_avatar`, `is_change_account`, `role_id`, `created_at`) VALUES
                                                                                                                                                                                                                (1, 'admin', '$2a$10$nyVFCwRC3/AjlDLfQvG4O.1omVzKT8kZWHRN8rAtfoCj.oIYYKL9S', 'Admin User', 'admin@bookstore.com', '0901234567', 1, 'Male', 'PLATINUM', 10000, 'https://res-console.cloudinary.com/duqhdj1ff/media_explorer_thumbnails/4a7b0c1e5e3d2c1b0a9f8e7d6c5b4a39/detailed_view', 'users/admin_avatar', 0, 1, NOW()),
                                                                                                                                                                                                                (2, 'user1', '$2a$10$nyVFCwRC3/AjlDLfQvG4O.1omVzKT8kZWHRN8rAtfoCj.oIYYKL9S', 'John Doe', 'user1@bookstore.com', '0901234568', 1, 'Male', 'SILVER', 2500, 'https://res-console.cloudinary.com/duqhdj1ff/media_explorer_thumbnails/default_user', 'users/user1_avatar', 0, 2, NOW()),
                                                                                                                                                                                                                (3, 'user2', '$2a$10$nyVFCwRC3/AjlDLfQvG4O.1omVzKT8kZWHRN8rAtfoCj.oIYYKL9S', 'Jane Smith', 'user2@bookstore.com', '0901234569', 1, 'Female', 'GOLD', 5500, 'https://res-console.cloudinary.com/duqhdj1ff/media_explorer_thumbnails/default_user', 'users/user2_avatar', 0, 2, NOW()),
                                                                                                                                                                                                                (4, 'user3', '$2a$10$nyVFCwRC3/AjlDLfQvG4O.1omVzKT8kZWHRN8rAtfoCj.oIYYKL9S', 'Bob Johnson', 'user3@bookstore.com', '0901234570', 1, 'Male', 'BRONZE', 500, 'https://res-console.cloudinary.com/duqhdj1ff/media_explorer_thumbnails/default_user', 'users/user3_avatar', 0, 2, NOW());
...
-- BOOKS
-- =====================================================
INSERT INTO `books` (`book_id`, `title`, `isbn`, `language`, `description`, `page_count`, `cover_type`, `stock_quantity`, `price`, `avg_rating`, `sale_percent`, `is_active`, `weight`, `length`, `width`, `height`, `public_id_cover_image`, `publisher_id`, `created_at`) VALUES
                                                                                                                                                                                                                (1, '1984', '978-0451524935', 'English', 'A dystopian social science fiction novel', 328, 'Hardcover', 50, 15.99, 4.5, 10, 1, 0.5, 25, 18, 3, 'books/1984_cover', 1, NOW()),
                                                                                                                                                                                                                (2, 'Harry Potter and the Sorcerers Stone', '978-0439708180', 'English', 'A young wizard begins his magical journey', 309, 'Hardcover', 100, 14.99, 4.8, 5, 1, 0.7, 23, 16, 4, 'books/hp1_cover', 2, NOW()),
                                                                                                                                                                                                                (3, 'The Shining', '978-0385121675', 'English', 'A psychological horror novel', 447, 'Paperback', 40, 12.99, 4.3, 15, 1, 0.8, 24, 17, 5, 'books/shining_cover', 1, NOW()),
                                                                                                                                                                                                                (4, 'Brave New World', '978-0060085260', 'English', 'A dystopian novel about a futuristic world', 288, 'Paperback', 60, 13.99, 4.2, 20, 1, 0.6, 22, 15, 3, 'books/bnw_cover', 1, NOW()),
                                                                                                                                                                                                                (5, 'The Fellowship of the Ring', '978-0544003415', 'English', 'The first book in the Lord of the Rings series', 423, 'Hardcover', 75, 18.99, 4.7, 0, 1, 1.0, 26, 19, 6, 'books/lotr_cover', 1, NOW());
...
INSERT INTO `orders` (`order_id`, `status`, `vat_rate`, `total_amount`, `customer_id`, `created_at`) VALUES
                                                                                                         (1, 'PENDING', 0.05, 250.00, 2, NOW()),
                                                                                                         (2, 'PENDING', 0.05, 200.00, 3, NOW());
