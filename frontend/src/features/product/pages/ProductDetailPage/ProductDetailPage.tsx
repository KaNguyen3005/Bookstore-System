...
const ProductDetailPage: React.FC = () => {
  ...
  // ================= AUTHOR FORMAT =================
  const authorNames =
    book.authors?.map((a) => a.authorName).join(", ") || "Không rõ";
              ...
              <div className="policy-list">
                ...
                <div className="policy-item">
                  ...
                  <div className="policy-text">
                    <p>
                      <strong>Thời gian giao hàng:</strong> giao nhanh, uy tín
                    </p>
                  </div>
          ...
          <div className="product-detail-right-col">
            <div className="product-card-white info-main-card">
              ...
              <div className="detail-meta-grid">
                ...
                <div className="meta-item">
                  Hình thức bìa: <strong>{book.coverType || "Bìa mềm"}</strong>
                </div>
              </div>

              {/* RATING */}
              {/* <div className="detail-rating-row">
                <div className="stars-row">{renderRating(book.avgRating)}</div>
            ...
            <div className="product-card-white mt-4 delivery-info-card">
              ...
              <div className="delivery-location">
                ...
                <div className="location-text">
                  Giao hàng đến <strong>TP. Hồ Chí Minh</strong>{" "}
            ...
            <div className="product-card-white mt-4 description-section">
              ...
              <div className="description-content">
                ...
                <p>
                  {book.description ||
                    `Những câu chuyện nhỏ xảy ra ở một ngôi làng nhỏ... Đây là tác phẩm đầy ý nghĩa của tác giả ${authorNames}.`}
                </p>
              </div>
            </div>
          </div>
